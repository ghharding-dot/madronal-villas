...
export const metadata = { title: 'Discover El Madroñal', description: 'Discover El Madroñal and the very best of Marbella, from beaches and dining to family days and outdoor adventures.', alternates: { canonical: '/discover', languages: { en: '/discover', es: '/es/descubrir', 'x-default': '/discover' } } };
export default function DiscoverPage() { return <><SiteHeader languageHref="/es/descubrir" /><main>
