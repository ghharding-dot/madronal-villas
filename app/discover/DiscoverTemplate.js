...
export function VillaCta() { return <section className="pad discoverCta"><div className="wrap collectionInner"><p className="eyebrow">Your Private Retreat</p><h2>Stay at the heart<em>of El Madroñal.</em></h2><p>Explore our private residences, currently off rental, or request a bespoke selection of available Marbella villas through PF EuroAsia and The Luxury Villa Collection.</p><div className="actions"><Link className="btn gold" href="/villa-candela">Villa Candela</Link><Link className="btn outlineBtn" href="/villa-lampara">Villa Lámpara</Link><a className="under" href="https://www.pfeuroasia.com/luxury-villa-rentals#villa-enquiry">Rental enquiry</a></div></div></section>; }
